...
\begin{minipage}[t]{0.275\textwidth} % 27.5% of the page width for the first row of icons
	...
	\icon{MapMarker}{10}{Chemin des Covets 13,} \\
...
\begin{entrylist}
	...
	\entry
      ...
      Large performance optimizations with analysis in PostgreSQL/Python. \\
...
\begin{minipage}[t]{0.3\textwidth}
  ...
  Music, Bass guitar, Reading, Photography, Walks, Learning new technologies, ...
\end{minipage}
\hfill
\begin{minipage}[t]{0.3\textwidth}
	\vspace{-\baselineskip} % Required for vertically aligning minipages
